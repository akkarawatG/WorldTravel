                      ...
                      <SwiperSlide key={slide.id} className="relative w-full h-full">
                        ...
                        <div className="absolute top-[140px] left-1/2 -translate-x-1/2 z-30 w-[1128px] h-[246px] flex flex-col items-center justify-center gap-[10px]">
                          <div className="w-[635px] h-[170px] flex flex-col items-center gap-[32px]">
                            ...
                            >
                              <span className="font-Inter font-normal text-[20px] leading-[100%] text-white">Start Planning</span>
                            </button>
                          </div>
                        </div>
                  ...
                  <div className="flex flex-col gap-2 min-w-0">
                    ...
                    <div className="w-full h-[87px] flex flex-col gap-[4px] min-w-0">
                      ...
                      <div className="flex items-center gap-[4px]">
                        ...
                        <span className="text-xs font-medium text-[#9E9E9E] ml-1">({place.rating})</span>
                      </div>
