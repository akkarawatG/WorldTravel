...
import { Search, MapPin, ArrowLeft, ArrowRight, Map, Star, Building2, Check, ChevronLeft, ChevronRight, Plus } from "lucide-react";
                      ...
                      <div className="flex flex-col gap-2 min-w-0">
                        ...
                        <div className="w-full h-[87px] flex flex-col gap-[4px] min-w-0">
                          ...
                          <p className="flex items-center gap-1 text-[14px] font-inter font-normal text-[#9E9E9E] w-full">
                            ...
                            <span className="truncate leading-none">{place.province_state}, {place.country}</span>
                          </p>
